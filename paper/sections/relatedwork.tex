...
targets~\cite{abeyrathna2020regression}---the setting we build on. TM Composites further
combine specialised machines to reach competitive image-classification
accuracy~\cite{gronningsaeter2024composites}. On the application side, Tsetlin Machines
have been used to discover interpretable rules in natural language
...
networks~\cite{hinton2015distilling} but remains largely unexplored for Tsetlin Machines,
